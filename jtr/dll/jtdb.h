...
#define MAX_REALTIME_NUM		(UINT8)5
...
#define MAX_YLF_WAIT			10
#define MAX_SYNERR_COUNT		30
#define MIN_SYN_LEN				10
...
typedef struct tag_CrossData_t
{
	...
	UINT8 jcqStartGreenStep[4][MAX_JCQ_NUM];//modified 10,08,2001
	UINT8 jcqEndGreenStep[4][MAX_JCQ_NUM];//modified 10,08,2001
