...
//function protype
//void InterpretClient(char * pMsgBuf,int RecLen,BYTE Index);
UINT8 FormCRC(UINT8 * pMsgIn,UINT8 bLen);
void InitSvrData(void);
UINT8 Comm2Opr(UINT8 CommIndex);
UINT16 CombineByte(UINT8 ByteHi,UINT8 ByteLo);
BOOLEAN CheckMonStatus(UINT8 OprIndex,UINT16 MonitorNo,UINT8 *pNotifyOpr);
BOOLEAN CheckCamStatus(UINT8 OprIndex,UINT16 CameraNo,UINT8 *pNotifyOpr);
BOOLEAN CheckDevStatus(UINT8 OprIndex,UINT16 CameraNo,UINT16 MonitorNo);
/*_inline*/ UINT8 GetCommandNo(MonitorEvent_t *Msg);
/*_inline*/ UINT8 GetEventType(MonitorEvent_t *Msg);
BOOLEAN SendCameCtlProc(SendCameraCtl_t * Msg,UINT8,UINT8);
BOOLEAN LogonProc(OprLogin_t * Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN WnPMatch(char *,char *);
UINT8 GetOprIndex(char * OprName);
void SetCamePermit(char *,UINT8);
void SetMonPermit(char *,UINT8);
int scanValue (char * src, char * dest, int pos);
void LogoutProc(UINT8 OprIndex);
BOOLEAN VariSpeedCtrProc(VariSpeedCtl_t *Msg,UINT8,UINT8);		
BOOLEAN SendCurMonAssignProc(SendCurMonitorAssign_t  *Msg,UINT8,UINT8);
BOOLEAN Switch2MonitorProc(Switch2Monitor_t *Msg,UINT8,UINT8);
BOOLEAN VideoLossMaskProc(VideoLossMask_t *Msg,UINT8 Command,UINT8 Index);
BOOLEAN StartMacroProc(StartMacro_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN StopMacroProc(StopMacro_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN NextCameraProc(NextCamera_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN PreCameraProc(PreCamera_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CameraReleaseProc(CameraRelease_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN MonitorStatusProc(MonitorStatus_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CameraLockProc(CameraLock_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CameraClearProc(CameraClear_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CameraCtlOverrideProc(CameraCtlOverride_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CheckCameraProc(CheckCamera_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN VideoLossProc(VideoLoss_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN VideoLossDetectProc(VideoLossDetect_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN IodevProc(IODev_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN TestPortProc(TestPort_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN Camera2MonInfoProc(Camera2MonitorInfo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN DataTimeProc(DataTimeInfo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN Camera2MonitorProc(Camera2Monitor_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ReqUpdatesProc(RequestUpdates_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CurAlarmNoProc(CurAlarmNo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN TrippedAlarmNoProc(TrippedAlarmNo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN PosnAttrInfoProc(PosnAttrInfo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN EquipStatusProc(EquipStatus_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN SelectAlarmProc(SelectAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ArmAlarmProc(ArmAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN DisarmAlarmProc(DisarmAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN StepAlarmProc(StepAlarms_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN GetLastAlarmProc(GetLastAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN StepActiveAlarmProc(StepActiveAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ResetAlarmProc(ResetAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN AlarmInfoProc(AlarmInfo_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN StarAlarmProc(StartAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN SendErrorProc(SendError_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN SendFatalErrProc(SendFatalErr_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN MimiSwitchProc(MimicSwitch_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN GdiCtlProc(GdiCtl_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ReleaseMacroProc(ReleaseMacro_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ArmTableProc(ArmTable_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN StepMacroProc(StepMacro_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN SelectMacroProc(SelectMacro_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN UpdateArmTableProc(UpdateArmTable_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ArmInputProc(ArmInput_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN GdiReportProc(GdiReport_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN MacroReportProc(MacroReport_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN LastVideoLossProc(LastVideoLoss_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN CheckPinProc(CheckPin_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN RecieveAlarmProc(RecieveAlarm_t *Msg,UINT8 Command,UINT8 CommIndex);
BOOLEAN ForcedReaseProc(ForcedRelease_t *Msg,UINT8 Command,UINT8 CommIndex);
UINT8 CalcuCRC(UINT8 *buf, UINT8 len);
BOOLEAN SvrLogonProc(void);
UINT8 Int2BcdHi(UINT16 IntValue);
UINT8 Int2BcdLo(UINT16 IntValue);
void SetResTable(void);
BOOLEAN CheckResource(UINT8 Command,UINT8 OprIndex,UINT8 *pNotifyOpr);
void SetSoleResource(UINT8 OprIndex,UINT8 Command);
void WaitClientProc(UINT8 *pNotifyOpr);
void SvrTimeoutCheckProc(void);
void CheckSvrData(void);
void SendTest(void);
UINT8 Comm2OprIndex(UINT8 CommIndex);
void ClearHisData(UINT8 OprIndex);
void ClearUsedData(UINT8 OprIndex);
